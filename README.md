...
- [ ] `REPLAY_PROTOCOL_NUMERICS.md` — replay session caps, ablation budgets, eligibility-trace decay
- [ ] `MEMORY_WRITE_GATE_NUMERICS.md` — verification thresholds, status TTL'ler
